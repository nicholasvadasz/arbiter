...
class YOLO(object):
    ...
    def __init__(self, **kwargs):
        ...
        self.boxes, self.scores, self.classes, self.box_scores = self.generate()
    ...
    def generate(self):
        ...
        boxes, scores, classes, box_scores = yolo_eval(self.yolo_model.output, self.anchors,
    ...
    def detect_image(self, image):
        ...
        out_boxes, out_scores, out_classes, box_scores = self.sess.run(
            [self.boxes, self.scores, self.classes, self.box_scores],
            feed_dict={
